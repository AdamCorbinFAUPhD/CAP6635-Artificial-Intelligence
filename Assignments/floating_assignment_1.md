...
- Sometimes AI is look down upon because it cant explain it self on how it made its decisions.
### AI Bias
...
### Adversarial attacks
- Its possible to add some data that doesn't look obvious to a human but it throws off the AI by a lot. Insert picture at 1:31. We have an example here were some pixels were changed and AI is not classifying this as a hammer where it should be a humming bird
